    ...
    <section class="product-search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL; ?>product-search.php" method="POST">
                <input type="search" name="search" placeholder="Search for parts.." required>
    ...
    <section class="product-menu">
                        ...
                        <div class="product-menu-img">
                            <?php 
                                ...
                                else
                                {
                                    //Image Available
                                    ?>
                                    <img src="<?php echo SITEURL; ?>images/product/<?php echo $image_name; ?>" alt="1" class="img-responsive img-curve">
                                    <?php
                                }
                            ?>
        ...
        <p class="text-center">
            <a href="<?php echo SITEURL; ?>product.php?product_id=<?php echo $id; ?>">See All Product</a>
        </p>
    </section>
